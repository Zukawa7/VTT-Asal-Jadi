...
class MobileNav {
  ...
  createMenu() {
    ...
    menu.className =
      'fixed top-0 left-0 bottom-0 w-[250px] bg-[#11131f] border-r border-[#26283b] z-[1001] transform -translate-x-full transition-transform duration-300 p-6 shadow-[0px_16px_40px_#000000a0]';
    menu.id = 'mobileMenu';
    menu.innerHTML = `
